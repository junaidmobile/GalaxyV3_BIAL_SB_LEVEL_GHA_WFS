...
function RecordGoodsDelivery_PDA() {
    ...
    var InputXML = '<Root><WDOSEQNO>' + WDOSeqNo + '</WDOSEQNO><SignatureImage>' + signitureDataURL + '</SignatureImage><ImageData>' + imgDataForSave + '</ImageData><AirportCity>' + AirportCity + '</AirportCity><Culture>' + PreferredLanguage + '</Culture><UserID>' + UserId + '</UserID></Root>';
