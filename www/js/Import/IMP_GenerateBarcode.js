        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response != null && response != "") {
                    ...
                    html += '<thead>';
                    html += '<tr>';
                    html += '<th height="30" style="background-color:rgb(208, 225, 244);" >Trolley Number</th>';
...
function fnPackageIDList(TrollyRowId, FlightSeqNo, TrolleyNumber, StickerValue, TrolleyStatus, StickerPrintData) {
    //if (PackageId != '') {
    html += '<tr>';
    html += '<td style="background: rgb(224, 243, 215);">' + TrolleyNumber + '</td>';
    ...
    html += '<td style="background-color: rgb(224, 243, 215);">  <a style="text-align: center;margin-left: 5px;color: #000;background-color: rgb(224, 243, 215);"  onclick="GetTrolleyDetailsonClickPrint(\'' + TrollyRowId + '\');"class=" form-control glyphicon glyphicon-print"></a></td>';
            ...
            success: function (response) {
                ...
                if (response != null && response != "") {
                    $(xmlDoc).find('Table').each(function (index) {
                        ...
                        strPrint = String(sendValueToPrinter);
