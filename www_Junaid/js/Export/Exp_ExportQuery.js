...
function fnScreeningMethod(ScreeningMethod, ScanTimeStamp, userName) {
    ...
    html += "<td height='30' onclick='GetMeetingByNo(abc)'style='background: rgb(224, 243, 215);padding-left: 4px;font-size:14px'align='left'>" + ScreeningMethod + "</td>";

    html += "<td height='30' onclick='GetMeetingByNo(abc)'style='background: rgb(224, 243, 215);padding-left: 4px;font-size:14px'align='left'>" + ScanTimeStamp + "</td>";
