...
function openScannerForULDScan() {
    ...
    function (result) {
        ...
        if ($("#txtScanULD").val() != '') {
            var value = $("#txtScanULD").val();// parseInt(this.value, 10),
            var result = value.replace(/^(.{3})(.{5})(.*)$/, "$1 $2 $3");
            dd = document.getElementById('ddlULDNo'),
            index = 0;
...
function openScannerForAWBNoScan() {
    ...
    function (result) {
        ...
        var str = barCodeResule;
        console.log('barCodeResule', barCodeResule)
        $("#txtScanAWBNo").val(str);
        document.activeElement.blur();

        if ($("#txtScanAWBNo").val() != '') {
            var value = $("#txtScanAWBNo").val();// parseInt(this.value, 10),
...
function openScannerForHAWBNoScan() {
    ...
    function (result) {
        ...
        if ($("#hawbLists").val() != '') {
            var value = $("#hawbLists").val();// parseInt(this.value, 10),
            dd = document.getElementById('ddlHAWBNo'),
            index = 0;
